...
class BentBarSeatedCable extends StatelessWidget {
  const BentBarSeatedCable({Key? key}) : super(key: key);

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text("Bent Bar Seated Cable Row"),
